...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{84321169}\NormalTok{)}
\NormalTok{N \textless{}{-}}\StringTok{ }\DecValTok{180}
\NormalTok{sigma\_noise \textless{}{-}}\StringTok{ }\FloatTok{0.5}
\CommentTok{\# we repeat each value of age 10 times to make filtering operation easier to see}
\NormalTok{sim\_waffles \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{MedianAgeMarriage =} \KeywordTok{rep}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\OperatorTok{{-}}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DataTypeTok{length.out=}\DecValTok{9}\NormalTok{), }\DecValTok{20}\NormalTok{), }
                      \DataTypeTok{Divorce =} \KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, sigma\_noise),}
                      \DataTypeTok{Marriage =} \OperatorTok{{-}}\KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, sigma\_noise))}

\NormalTok{MD\_plot \textless{}{-}}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Marriage, }\DataTypeTok{y=}\NormalTok{Divorce)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{\textasciitilde{}}\NormalTok{x) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Marriage rate"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Divorce rate"}\NormalTok{)}
  
\NormalTok{AD\_plot \textless{}{-}}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{MedianAgeMarriage, }\DataTypeTok{y=}\NormalTok{Divorce)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{\textasciitilde{}}\NormalTok{x) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Median age marriage"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Divorce rate"}\NormalTok{)}
  
\NormalTok{AM\_plot \textless{}{-}}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{MedianAgeMarriage, }\DataTypeTok{y=}\NormalTok{Marriage)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{\textasciitilde{}}\NormalTok{x) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Median age marriage"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Marriage rate"}\NormalTok{)}

\NormalTok{MD\_plot }\OperatorTok{|}\StringTok{ }\NormalTok{AD\_plot }\OperatorTok{|}\StringTok{ }\NormalTok{AM\_plot}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{MD\_plot \textless{}{-}}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Marriage, }\DataTypeTok{y=}\NormalTok{Divorce)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{\textasciitilde{}}\NormalTok{x, }\DataTypeTok{alpha=}\FloatTok{0.1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(MedianAgeMarriage }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{), }\DataTypeTok{color=}\StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(MedianAgeMarriage }\OperatorTok{!=}\StringTok{ }\DecValTok{1}\NormalTok{), }\DataTypeTok{alpha=}\FloatTok{0.15}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Marriage rate"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Divorce rate"}\NormalTok{) }
\NormalTok{AD\_plot \textless{}{-}}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{MedianAgeMarriage, }\DataTypeTok{y=}\NormalTok{Divorce)) }\OperatorTok{+}\StringTok{ }
...
\NormalTok{AM\_plot \textless{}{-}}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Marriage, }\DataTypeTok{y=}\NormalTok{MedianAgeMarriage)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{\textasciitilde{}}\NormalTok{x) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(MedianAgeMarriage }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{), }\DataTypeTok{color=}\StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(MedianAgeMarriage }\OperatorTok{!=}\StringTok{ }\DecValTok{1}\NormalTok{), }\DataTypeTok{alpha=}\FloatTok{0.15}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Median age marriage"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Marriage rate"}\NormalTok{) }

\NormalTok{MD\_A1\_plot \textless{}{-}}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sim\_waffles }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(MedianAgeMarriage }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{), }
         \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Marriage, }\DataTypeTok{y=}\NormalTok{Divorce)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{\textasciitilde{}}\NormalTok{x, }\DataTypeTok{color=}\StringTok{"red"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{(}\DataTypeTok{color=}\StringTok{"red"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Marriage rate"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Divorce rate"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{subtitle =} \StringTok{"Pr( |Mariage Age = 1)"}\NormalTok{)}

\NormalTok{(AD\_plot }\OperatorTok{|}\StringTok{ }\NormalTok{MD\_plot) }\OperatorTok{/}
\NormalTok{(MD\_A1\_plot }\OperatorTok{|}\NormalTok{AM\_plot)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data}\NormalTok{(}\StringTok{"WaffleDivorce"}\NormalTok{)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1212}\NormalTok{)}
\NormalTok{N \textless{}{-}}\StringTok{ }\KeywordTok{nrow}\NormalTok{(WaffleDivorce)}
\NormalTok{sim\_waffles \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{MedianAgeMarriage =} \KeywordTok{rnorm}\NormalTok{(N),}
                      \DataTypeTok{Divorce =} \OperatorTok{{-}}\KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, }\FloatTok{0.1}\NormalTok{),}
                      \DataTypeTok{Marriage =} \OperatorTok{{-}}\KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, }\FloatTok{0.01}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim\_waffles \textless{}{-}}
\StringTok{  }\NormalTok{sim\_waffles }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{A =}\NormalTok{ MedianAgeMarriage,}
         \DataTypeTok{M =}\NormalTok{ Marriage,}
         \DataTypeTok{D =}\NormalTok{ Divorce)}

\NormalTok{sim\_waffles\_fit \textless{}{-}}\StringTok{ }\KeywordTok{quap}\NormalTok{(}
  \KeywordTok{alist}\NormalTok{(}
\NormalTok{    D }\OperatorTok{\textasciitilde{}}\StringTok{ }\KeywordTok{dnorm}\NormalTok{(mu , sigma) ,}
\NormalTok{    mu \textless{}{-}}\StringTok{ }\NormalTok{a }\OperatorTok{+}\StringTok{ }\NormalTok{bM}\OperatorTok{*}\NormalTok{M }\OperatorTok{+}\StringTok{ }\NormalTok{bA}\OperatorTok{*}\NormalTok{A,}
\NormalTok{    a }\OperatorTok{\textasciitilde{}}\StringTok{ }\KeywordTok{dnorm}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.2}\NormalTok{),}
\NormalTok{    bA }\OperatorTok{\textasciitilde{}}\StringTok{ }\KeywordTok{dnorm}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{10}\NormalTok{),}
\NormalTok{    bM }\OperatorTok{\textasciitilde{}}\StringTok{ }\KeywordTok{dnorm}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{10}\NormalTok{),}
\NormalTok{    sigma }\OperatorTok{\textasciitilde{}}\StringTok{ }\KeywordTok{dexp}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{  ), }
  \DataTypeTok{data =}\NormalTok{ sim\_waffles,}
\NormalTok{)}

\KeywordTok{precis}\NormalTok{(sim\_waffles\_fit)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{posterior\_samples \textless{}{-}}\StringTok{ }
\StringTok{  }\NormalTok{rethinking}\OperatorTok{::}\KeywordTok{extract.samples}\NormalTok{(sim\_waffles\_fit) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{bA\_true =}\NormalTok{ bA }\OperatorTok{{-}}\StringTok{ }\NormalTok{bM)}

\KeywordTok{ggplot}\NormalTok{(posterior\_samples, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{bA\_true)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_histogram}\NormalTok{(}\DataTypeTok{bins=}\DecValTok{100}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"bA\_true = bA {-} bM"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1231455}\NormalTok{)}
\NormalTok{sim\_waffles \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{MedianAgeMarriage =} \KeywordTok{rnorm}\NormalTok{(N),}
                      \DataTypeTok{Divorce =} \KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, }\FloatTok{0.1}\NormalTok{),}
                      \DataTypeTok{Marriage =} \OperatorTok{{-}}\KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, }\FloatTok{0.01}\NormalTok{),}
                      \DataTypeTok{epsilon =} \KeywordTok{rnorm}\NormalTok{(N))}

\KeywordTok{ggplot}\NormalTok{(sim\_waffles, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{epsilon, }\DataTypeTok{y=}\NormalTok{Divorce)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_smooth}\NormalTok{(}\DataTypeTok{method=}\StringTok{"lm"}\NormalTok{, }\DataTypeTok{formula=}\NormalTok{y}\OperatorTok{\textasciitilde{}}\NormalTok{x) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\KeywordTok{expression}\NormalTok{(epsilon)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Marriage rate"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simulate\_waffles \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(sigma\_noise)\{}
  \CommentTok{\# generate same data but for noise in Marraige from Age relationship}
  \KeywordTok{set.seed}\NormalTok{(}\DecValTok{169084}\NormalTok{)}
\NormalTok{  sim\_df \textless{}{-}}\StringTok{ }\NormalTok{sim\_waffles \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{MedianAgeMarriage =} \KeywordTok{rnorm}\NormalTok{(N),}
                                  \DataTypeTok{Divorce =} \KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, }\FloatTok{0.1}\NormalTok{),}
                                  \DataTypeTok{Marriage =} \OperatorTok{{-}}\KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, sigma\_noise))}
  
  \CommentTok{\# fit data using OLS and pulling out two slope coefficients}
  \KeywordTok{lm}\NormalTok{(Divorce }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{Marriage }\OperatorTok{+}\StringTok{ }\NormalTok{MedianAgeMarriage, }\DataTypeTok{data=}\NormalTok{sim\_df) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{summary}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\NormalTok{.}\OperatorTok{$}\NormalTok{coefficients }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{data.frame}\NormalTok{() }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{rownames\_to\_column}\NormalTok{(}\StringTok{"Variable"}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{slice}\NormalTok{(}\OperatorTok{{-}}\DecValTok{1}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{LowerCI =}\NormalTok{ Estimate }\OperatorTok{{-}}\StringTok{ }\NormalTok{Std..Error,}
           \DataTypeTok{UpperCI =}\NormalTok{ Estimate }\OperatorTok{+}\StringTok{ }\NormalTok{Std..Error) }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{select}\NormalTok{(Variable, Estimate, LowerCI, UpperCI)}
\NormalTok{\}}

\NormalTok{simulated\_noise \textless{}{-}}\StringTok{ }
\StringTok{  }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{epsilon =}\KeywordTok{exp}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\KeywordTok{log}\NormalTok{(}\FloatTok{0.001}\NormalTok{), }\KeywordTok{log}\NormalTok{(}\FloatTok{0.3}\NormalTok{), }\DataTypeTok{length.out =} \DecValTok{100}\NormalTok{))) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{group\_by}\NormalTok{(epsilon) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{do}\NormalTok{(}\KeywordTok{simulate\_waffles}\NormalTok{(.}\OperatorTok{$}\NormalTok{epsilon))}

\KeywordTok{ggplot}\NormalTok{(simulated\_noise, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{epsilon, }\DataTypeTok{y=}\NormalTok{Estimate)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_ribbon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{LowerCI, }\DataTypeTok{ymax=}\NormalTok{UpperCI, }\DataTypeTok{fill=}\NormalTok{Variable), }\DataTypeTok{alpha=} \FloatTok{0.5}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom\_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{color=}\NormalTok{Variable)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale\_x\_log10}\NormalTok{(}\DataTypeTok{name=}\KeywordTok{expression}\NormalTok{(epsilon)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Slope estimate  ± standard error"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{subtitle =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Marriage = MedianAgeMarriage + Normal(0, "}\NormalTok{, epsilon, }\StringTok{")"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{data}\NormalTok{(}\StringTok{"WaffleDivorce"}\NormalTok{)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{8973791}\NormalTok{)}
\NormalTok{N \textless{}{-}}\StringTok{ }\KeywordTok{nrow}\NormalTok{(WaffleDivorce)}
\NormalTok{sim\_waffles \textless{}{-}}\StringTok{ }\KeywordTok{tibble}\NormalTok{(}\DataTypeTok{Marriage =} \KeywordTok{rnorm}\NormalTok{(N),}
                      \DataTypeTok{MedianAgeMarriage =} \OperatorTok{{-}}\KeywordTok{rnorm}\NormalTok{(N, Marriage, }\FloatTok{0.2}\NormalTok{),}
                      \DataTypeTok{Divorce =} \OperatorTok{{-}}\KeywordTok{rnorm}\NormalTok{(N, MedianAgeMarriage, }\FloatTok{0.2}\NormalTok{))}
