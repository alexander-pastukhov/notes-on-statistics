...
\FunctionTok{cat}\NormalTok{(}\StringTok{"mean = "}\NormalTok{, }\FunctionTok{mean}\NormalTok{(p), }\StringTok{", variance of log(p) = "}\NormalTok{, rethinking}\SpecialCharTok{::}\FunctionTok{var2}\NormalTok{(logp), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, }\AttributeTok{sep =} \StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{cat}\NormalTok{(}\StringTok{"lppd    ="}\NormalTok{, lppd, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"lppd\_IS ="}\NormalTok{, lppd\_IS, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"lppd {-} lppd\_IS = "}\NormalTok{, lppd }\SpecialCharTok{{-}}\NormalTok{ lppd\_IS, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{lppd\_df }\OtherTok{\textless{}{-}} \FunctionTok{bind\_rows}\NormalTok{(}
  ...
  \FunctionTok{tibble}\NormalTok{(}\AttributeTok{Variance =}\NormalTok{ purrr}\SpecialCharTok{::}\FunctionTok{map\_dbl}\NormalTok{(delta, }\SpecialCharTok{\textasciitilde{}}\FunctionTok{var2}\NormalTok{(}\FunctionTok{log}\NormalTok{(}\FunctionTok{create\_p}\NormalTok{(.)))),}
       ...
       \AttributeTok{Kind =} \StringTok{"lppd\_IS"}\NormalTok{))}
...
\includegraphics{notes-on-statistical-rethinking_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\begin{center}\includegraphics{notes-on-statistical-rethinking_files/figure-latex/unnamed-chunk-36-1} \end{center}
...
\begin{center}\includegraphics{notes-on-statistical-rethinking_files/figure-latex/unnamed-chunk-53-1} \end{center}
...
\includegraphics{notes-on-statistical-rethinking_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\includegraphics{notes-on-statistical-rethinking_files/figure-latex/unnamed-chunk-57-1.pdf}
...
\includegraphics{notes-on-statistical-rethinking_files/figure-latex/unnamed-chunk-62-1.pdf}
...
\includegraphics{notes-on-statistical-rethinking_files/figure-latex/unnamed-chunk-68-1.pdf}
