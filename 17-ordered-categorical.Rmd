...
ggplot() +
  ...
  labs(title = "Many-to-one mapping", 
       subtitle = 'Likelihood of response correspond to the area under the curve.')
...
ggplot() +
  ...
  labs(title = "One-to-one mapping", 
       subtitle = 'Likelihood of response correspond to probablity density for value 4 (red dot).')
