...
\$\$Pr(\mu, \sigma \textbar{} y) = \frac{\prod_i Normal(y_i| \mu, \sigma) \cdot Normal(mu | 0, 10) \cdot Exponential(\sigma | 1)}
\{\int \int \prod\_i Normal(y\_i\textbar{} \mu, \sigma) \cdot Normal(mu \textbar{} 0, 10) \cdot Exponential(\sigma \textbar{} 1) \partial \mu \partial \sigma\}
