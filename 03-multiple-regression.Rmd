...
Now marriage rate causes age of marriage that, in turn, causes divorce rate. Again, us use synthetic data, so that we can be sure what causes what. However, we will add a fair amount of noise to make it more like real data and avoid multicoliniarity.
